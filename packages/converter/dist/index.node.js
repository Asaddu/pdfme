...
if (pdfjsModule.GlobalWorkerOptions) {
    ...
    pdfjsModule.default.GlobalWorkerOptions.workerSrc = PDFJSWorker;
}
// Get the actual pdf.js library object
const pdfjs = pdfjsModule.default || pdfjsModule;
export const pdf2img = async (pdf, options = {}) => _pdf2img(pdf, options, {
    getDocument: (pdf) => pdfjs.getDocument({ data: pdf, isEvalSupported: false }).promise,
