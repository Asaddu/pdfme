import { z } from 'zod';
import type { PDFPage, PDFDocument } from '@asaddu/pdfme-pdf-lib';
 ...
 * @property {typeof import('@asaddu/pdfme-pdf-lib')} pdfLib The pdf-lib library used for rendering.
...
export interface PDFRenderProps<T extends Schema> {
    ...
    schema: T;
    basePdf: BasePdf;
    pdfLib: typeof import('@asaddu/pdfme-pdf-lib');
    pdfDoc: PDFDocument;
    page: PDFPage;
