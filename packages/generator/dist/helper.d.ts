import { Schema, Plugins, GeneratorOptions, Template, PDFRenderProps } from '@asaddu/pdfme-common';
import { PDFPage, PDFDocument, PDFEmbeddedPage } from '@asaddu/pdfme-pdf-lib';
